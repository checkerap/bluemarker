...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { date: @talk.date, event_id: @talk.event_id, title: @talk.title, user_id: @talk.user_id } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { date: @talk.date, event_id: @talk.event_id, title: @talk.title, user_id: @talk.user_id } }
