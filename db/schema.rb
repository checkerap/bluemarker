...
ActiveRecord::Schema.define(version: 2020_06_15_142015) do
  ...
  create_table "paper_authors", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_paper_authors_on_user_id"
  end
  ...
  create_table "talks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "description"
    t.text "live_video_link"
    t.text "recorded_video_link"
    t.string "timezone"
    t.integer "timespan"
    t.integer "category_id"
